...
Discord のテキストコマンドで操作する Music Bot です。最初のフェーズでは、Jockie Music の基本機能をコマンド中心で使えることを目標にしています。
...
この Bot では、YouTube の音声をできるだけそのまま Discord に流す構成を優先し、余計な再エンコードを避けることで遅延や音ズレを減らす方針を取っています。
